...
Namespace leadcatcher
    ...
    Partial Public Class LeadCatcherService
        ...
        Private AddLeadV3OperationCompleted As System.Threading.SendOrPostCallback
        
        Private CheckZIPOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.TestWS.My.MySettings.Default.TestWS_leadcatcher_LeadCatcherService
        ...
        '''<remarks/>
        Public Event AddLeadV3Completed As AddLeadV3CompletedEventHandler
        
        '''<remarks/>
        Public Event CheckZIPCompleted As CheckZIPCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("https://leadcatcher.ubh.com/AddLeadV3", RequestNamespace:="https://leadcatcher.ubh.com/", ResponseNamespace:="https://leadcatcher.ubh.com/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function AddLeadV3(ByVal firstName As String, ByVal lastName As String, ByVal address As String, ByVal city As String, ByVal state As String, ByVal zip As String, ByVal email As String, ByVal phoneNumber As String, ByVal details As String, ByVal brochure As String, ByVal keyString As String, ByVal optOut As String) As String
            Dim results() As Object = Me.Invoke("AddLeadV3", New Object() {firstName, lastName, address, city, state, zip, email, phoneNumber, details, brochure, keyString, optOut})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub AddLeadV3Async(ByVal firstName As String, ByVal lastName As String, ByVal address As String, ByVal city As String, ByVal state As String, ByVal zip As String, ByVal email As String, ByVal phoneNumber As String, ByVal details As String, ByVal brochure As String, ByVal keyString As String, ByVal optOut As String)
            Me.AddLeadV3Async(firstName, lastName, address, city, state, zip, email, phoneNumber, details, brochure, keyString, optOut, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub AddLeadV3Async(ByVal firstName As String, ByVal lastName As String, ByVal address As String, ByVal city As String, ByVal state As String, ByVal zip As String, ByVal email As String, ByVal phoneNumber As String, ByVal details As String, ByVal brochure As String, ByVal keyString As String, ByVal optOut As String, ByVal userState As Object)
            If (Me.AddLeadV3OperationCompleted Is Nothing) Then
                Me.AddLeadV3OperationCompleted = AddressOf Me.OnAddLeadV3OperationCompleted
            End If
            Me.InvokeAsync("AddLeadV3", New Object() {firstName, lastName, address, city, state, zip, email, phoneNumber, details, brochure, keyString, optOut}, Me.AddLeadV3OperationCompleted, userState)
        End Sub
        
        Private Sub OnAddLeadV3OperationCompleted(ByVal arg As Object)
            If (Not (Me.AddLeadV3CompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent AddLeadV3Completed(Me, New AddLeadV3CompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("https://leadcatcher.ubh.com/CheckZIP", RequestNamespace:="https://leadcatcher.ubh.com/", ResponseNamespace:="https://leadcatcher.ubh.com/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function CheckZIP(ByVal zipCode As String, ByVal keyString As String) As String
            Dim results() As Object = Me.Invoke("CheckZIP", New Object() {zipCode, keyString})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub CheckZIPAsync(ByVal zipCode As String, ByVal keyString As String)
            Me.CheckZIPAsync(zipCode, keyString, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub CheckZIPAsync(ByVal zipCode As String, ByVal keyString As String, ByVal userState As Object)
            If (Me.CheckZIPOperationCompleted Is Nothing) Then
                Me.CheckZIPOperationCompleted = AddressOf Me.OnCheckZIPOperationCompleted
            End If
            Me.InvokeAsync("CheckZIP", New Object() {zipCode, keyString}, Me.CheckZIPOperationCompleted, userState)
        End Sub
        
        Private Sub OnCheckZIPOperationCompleted(ByVal arg As Object)
            If (Not (Me.CheckZIPCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent CheckZIPCompleted(Me, New CheckZIPCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")>  _
    Public Delegate Sub AddLeadV3CompletedEventHandler(ByVal sender As Object, ByVal e As AddLeadV3CompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class AddLeadV3CompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")>  _
    Public Delegate Sub CheckZIPCompletedEventHandler(ByVal sender As Object, ByVal e As CheckZIPCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class CheckZIPCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
